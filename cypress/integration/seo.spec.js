...
describe('SEO', () => {
    ...
    it('has expected meta tags for the homepage', () => {
        ...
        cy.get('head meta[property="og:title"]').should('have.attr', 'content', themeConfig.directories[0].title);
        cy.get('head meta[property="og:description"]').should('have.attr', 'content', description);
        cy.get('head meta[property="og:image"]').should('have.attr', 'content', themeConfig.carouselImages[0]);
    ...
    it('has expected meta tags for a post', () => {
        const markdownPath = 'src/posts/art-ecmwf.md';
    ...
    it('has expected meta tags for a static page', () => {
        const markdownPath = 'src/pages/about.md';
